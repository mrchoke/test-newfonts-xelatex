...
% iannnnn-DOG
\defaultfontfeatures[iannnnnDOG]{
Path            = ./,
UprightFont     = *-Regular,
BoldFont        = *-Bold ,
Extension       = .ttf ,
...
% ChitPhumisak
\defaultfontfeatures[ChitPhumisak]{
Path            = ./,
Extension       = .ttf,
Mapping         = tex-text,
Script          = Thai
...
% SaoChingcha
\defaultfontfeatures[SaoChingcha]{
Path            = ./,
UprightFont     = *-Regular,
BoldFont        = *-Bold ,
Extension       = .otf ,
...
\newfontfamily\ChitPhumisak{ChitPhumisak}
...
\newfontfamily\iannnnnDOG{iannnnnDOG}[
  FontFace = {l}{n}{ Font = *-Light },
]

\newfontfamily\SaoChingcha{SaoChingcha}[
  FontFace = {l}{n}{ Font = *-Light },
]
...
\makeatletter
\def\flist{Laksaman,ChulabhornLikitText,Anakotmai,TUFont,Pridi,iannnnnDOG,ChitPhumisak,SaoChingcha}
...
\ifthenelse{\equal{#2}{Pridi}}%
 ...
 \ifthenelse{\equal{#2}{Anakotmai}}%
   { \renewfontfamily#1{#2}[%
    ...
    \ifthenelse{\equal{#2}{iannnnnDOG}}%
    { \renewfontfamily#1{#2}[%
     FontFace = {l}{n}{ Font = *-Light },
     Script=Thai,
     Language=Pali
   ]}{
    \ifthenelse{\equal{#2}{SaoChingcha}}%
    { \renewfontfamily#1{#2}[%
     FontFace = {l}{n}{ Font = *-Light },
     Script=Thai,
     Language=Pali
...
\section{\iannnnnDOG\fontseries{b}\fontshape{n}\selectfont iannnnn-DOG -- หมา\protect\footnote{โดย Prachya Singhto}}

\subsection{ตัวอย่างประโยคภาษาไทย}

\testthaipoem{\iannnnnDOG}{l}{n}

\testthaipoem{\iannnnnDOG}{m}{n}

\testthaipoem{\iannnnnDOG}{b}{n}


\subsection{ตัวอย่างภาษาอังกฤษ}

\testenglish{\iannnnnDOG}{l}{n}

\testenglish{\iannnnnDOG}{m}{n}

\testenglish{\iannnnnDOG}{b}{n}
...
\testligkern{\iannnnnDOG}{l}{n}

\testligkern{\iannnnnDOG}{m}{n}

\testligkern{\iannnnnDOG}{b}{n}


\subsection{ภาษาบาลี-สันสกฤต}

\testpali{\iannnnnDOG}{iannnnnDOG}{l}{n}

\testpali{\iannnnnDOG}{iannnnnDOG}{m}{n}

\testpali{\iannnnnDOG}{iannnnnDOG}{b}{n}

\vfil\pagebreak

\section{\ChitPhumisak\fontseries{b}\fontshape{n}\selectfont  จิตร ภูมิศักดิ์ -- {\LARGE A} \protect\footnote{โดย PrachathipaType}}

\subsection{ตัวอย่างประโยคภาษาไทย}

\testthaipoem{\ChitPhumisak}{m}{n}



\subsection{การจัดระดับตัวอักษรและตัวอักษรพิเศษ}

\testligkern{\ChitPhumisak}{m}{n}



\subsection{ภาษาบาลี-สันสกฤต}

\testpali{\TUFont}{ChitPhumisak}{m}{n}


\vfil\pagebreak

\section{\SaoChingcha\fontseries{b}\fontshape{n}\selectfont SaoChingcha - เสาชิงช้า \protect\footnote{โดย JD, Suppakit Chalermlarp}}

\subsection{ตัวอย่างประโยคภาษาไทย}

\testthaipoem{\SaoChingcha}{l}{n}

\testthaipoem{\SaoChingcha}{m}{n}

\testthaipoem{\SaoChingcha}{b}{n}


\subsection{ตัวอย่างภาษาอังกฤษ}

\testenglish{\SaoChingcha}{l}{n}

\testenglish{\SaoChingcha}{m}{n}

\testenglish{\SaoChingcha}{b}{n}
...
\testligkern{\SaoChingcha}{l}{n}

\testligkern{\SaoChingcha}{m}{n}

\testligkern{\SaoChingcha}{b}{n}


\subsection{ภาษาบาลี-สันสกฤต}

\testpali{\SaoChingcha}{SaoChingcha}{l}{n}

\testpali{\SaoChingcha}{SaoChingcha}{m}{n}

\testpali{\SaoChingcha}{SaoChingcha}{b}{n}
